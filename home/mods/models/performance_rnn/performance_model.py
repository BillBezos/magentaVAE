...
from mods.music.performance_lib import PerformanceEvent
...
class PerformanceRnnConfig(events_rnn_model.EventSequenceRnnConfig):
  ...
  def __init__(self, details, encoder_decoder, hparams, num_velocity_bins=0,
    ...
    super(PerformanceRnnConfig, self).__init__(
        details, encoder_decoder, hparams, mod_writer=mod_writer)
...
default_configs = {
    '01_performance': PerformanceRnnConfig(
    ...
    '02_performance_with_dynamics': PerformanceRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
    ...
    '03_density_conditioned_performance_with_dynamics': PerformanceRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
        ...
        encoder_decoder.ConditionalEventSequenceEncoderDecoder(
            encoder_decoder.MultipleEventSequenceEncoder([
                encoder_decoder.OneHotEventSequenceEncoderDecoder(
    ...
    '04_pitch_conditioned_performance_with_dynamics': PerformanceRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
    ...
    '05_multiconditioned_performance_with_dynamics': PerformanceRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
    ...
    '06_optional_multiconditioned_performance_with_dynamics': PerformanceRnnConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
            id='optional_multiconditioned_performance_with_dynamics',
            description='Optionally multiconditioned Performance RNN'),
        encoder_decoder.ConditionalEventSequenceEncoderDecoder(
            encoder_decoder.OptionalEventSequenceEncoder(
                encoder_decoder.MultipleEventSequenceEncoder([
                    encoder_decoder.OneHotEventSequenceEncoderDecoder(
                        performance_encoder_decoder.NoteDensityOneHotEncoding(
                            density_bin_ranges=[
