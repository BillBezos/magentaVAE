...
_NOTESEQUENCE_ORNAMENT_ORNTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GRACE_NOTE', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MORDENT', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TRILL', index=4, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ARPEGGIO', index=5, number=5,
      serialized_options=None,
      type=None),
  ],
...
_sym_db.RegisterEnumDescriptor(_NOTESEQUENCE_ORNAMENT_ORNTYPE)
...
_NOTESEQUENCE_ORNAMENT = _descriptor.Descriptor(
  name='Ornament',
  full_name='tensorflow.magenta.NoteSequence.Ornament',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='orn_type', full_name='tensorflow.magenta.NoteSequence.Ornament.orn_type', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instrument', full_name='tensorflow.magenta.NoteSequence.Ornament.instrument', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='program', full_name='tensorflow.magenta.NoteSequence.Ornament.program', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='tensorflow.magenta.NoteSequence.Ornament.start_time', index=3,
      number=4, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='tensorflow.magenta.NoteSequence.Ornament.end_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_pitch', full_name='tensorflow.magenta.NoteSequence.Ornament.start_pitch', index=5,
      number=6, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_pitch', full_name='tensorflow.magenta.NoteSequence.Ornament.end_pitch', index=6,
      number=7, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='velocity', full_name='tensorflow.magenta.NoteSequence.Ornament.velocity', index=7,
      number=8, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='is_drum', full_name='tensorflow.magenta.NoteSequence.Ornament.is_drum', index=8,
      number=9, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='notes', full_name='tensorflow.magenta.NoteSequence.Ornament.notes', index=9,
  ...
  nested_types=[],
  enum_types=[
    _NOTESEQUENCE_ORNAMENT_ORNTYPE,
  ],
  serialized_options=None,
  is_extendable=False,
  syntax='proto3',
...
_NOTESEQUENCE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ornaments', full_name='tensorflow.magenta.NoteSequence.ornaments', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='notes', full_name='tensorflow.magenta.NoteSequence.notes', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_time', full_name='tensorflow.magenta.NoteSequence.total_time', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='total_quantized_steps', full_name='tensorflow.magenta.NoteSequence.total_quantized_steps', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pitch_bends', full_name='tensorflow.magenta.NoteSequence.pitch_bends', index=12,
      number=10, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='control_changes', full_name='tensorflow.magenta.NoteSequence.control_changes', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='part_infos', full_name='tensorflow.magenta.NoteSequence.part_infos', index=14,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='source_info', full_name='tensorflow.magenta.NoteSequence.source_info', index=15,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text_annotations', full_name='tensorflow.magenta.NoteSequence.text_annotations', index=16,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='section_annotations', full_name='tensorflow.magenta.NoteSequence.section_annotations', index=17,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='section_groups', full_name='tensorflow.magenta.NoteSequence.section_groups', index=18,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quantization_info', full_name='tensorflow.magenta.NoteSequence.quantization_info', index=19,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subsequence_info', full_name='tensorflow.magenta.NoteSequence.subsequence_info', index=20,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sequence_metadata', full_name='tensorflow.magenta.NoteSequence.sequence_metadata', index=21,
  ...
  nested_types=[_NOTESEQUENCE_NOTE, _NOTESEQUENCE_ORNAMENT, _NOTESEQUENCE_TIMESIGNATURE, _NOTESEQUENCE_KEYSIGNATURE, _NOTESEQUENCE_TEMPO, _NOTESEQUENCE_PITCHBEND, _NOTESEQUENCE_CONTROLCHANGE, _NOTESEQUENCE_PARTINFO, _NOTESEQUENCE_SOURCEINFO, _NOTESEQUENCE_TEXTANNOTATION, _NOTESEQUENCE_QUANTIZATIONINFO, _NOTESEQUENCE_SUBSEQUENCEINFO, _NOTESEQUENCE_SECTIONANNOTATION, _NOTESEQUENCE_SECTION, _NOTESEQUENCE_SECTIONGROUP, ],
  enum_types=[
...
_NOTESEQUENCE_ORNAMENT.fields_by_name['orn_type'].enum_type = _NOTESEQUENCE_ORNAMENT_ORNTYPE
_NOTESEQUENCE_ORNAMENT.fields_by_name['notes'].message_type = _NOTESEQUENCE_NOTE
_NOTESEQUENCE_ORNAMENT.containing_type = _NOTESEQUENCE
_NOTESEQUENCE_ORNAMENT_ORNTYPE.containing_type = _NOTESEQUENCE_ORNAMENT
...
_NOTESEQUENCE.fields_by_name['ornaments'].message_type = _NOTESEQUENCE_ORNAMENT
...
NoteSequence = _reflection.GeneratedProtocolMessageType('NoteSequence', (_message.Message,), dict(
  ...
  Ornament = _reflection.GeneratedProtocolMessageType('Ornament', (_message.Message,), dict(
    DESCRIPTOR = _NOTESEQUENCE_ORNAMENT,
    __module__ = 'music_pb2'
    # @@protoc_insertion_point(class_scope:tensorflow.magenta.NoteSequence.Ornament)
    ))
  ,
...
_sym_db.RegisterMessage(NoteSequence.Ornament)
