...
class PerformanceEvent(object):
    ...
    def __init__(self, event_type, event_value):
        if not PerformanceEvent.NOTE_ON <= event_type <= PerformanceEvent.ORNAMENT:
...
class BasePerformance(events_lib.EventSequence):
    ...
    def __str__(self):
        ...
        for event in self:
            ...
            elif event.event_type == PerformanceEvent.ORNAMENT:
                strs.append('(%s, ORNAMENT)' % event.event_value)
            else:
    ...
    def _from_quantized_sequence(quantized_sequence, start_step,
                                 ...
                                 instrument=None, mod_writer=None):
...
#             step_list = []
#             idx_list = []
#             for step, idx, is_offset in onsets:
#                 print(step)
#                 if not step_list:
#                     print('a')
...
#                     print('b')
#                     sub = step - step_list[0]
#                     if sub > min_steps:
#                         osts.append(onsets[idx_list[0]])
#                         step_list = [step]
#                         idx_list = [idx]
#                     elif sub <= min_steps:
#                         step_list.append(step)
...
#                     print('c')
#                     sub = step - step_list[1]
#                     if sub > min_steps:
#                         grace_notes.append(sorted_notes[idx_list[1]])
#                         step_list = [step]
#                         idx_list = [idx]
#                     elif sub <= min_steps:
#                         step_list.append(step)
...
#                     print('d')
#                     sub = step - step_list[2]
#                     if sub > min_steps:
#                         mordents.append(sorted_notes[idx_list[2]])
#                         step_list = [step]
#                         idx_list = [idx]
#                     elif sub <= min_steps:
#                         step_list.append(step)
...
#                     print('e')
#                     sub = step - step_list[3]
#                     if sub > min_steps:
#                         turns.append(sorted_notes[idx_list[3]])
#                         step_list = [step]
#                         idx_list = [idx]
#                     elif sub <= min_steps:
#                         step_list.append(step)
#                         idx_list.append(idx)
#             return ((grace_notes, mordents, turns), osts)
#
# aos(onsets, 10)
#
#
...
#         sorted_notes = sorted(notes, key=lambda note: (
...
#                    for idx, note in enumerate(sorted_notes)]
#         # add ornaments
#         ornaments, onsets = aos(onsets, min_steps)
...
#
#         #mw.write(mw.model_dir, 'fq_performance_events', performance_events)
    ...
    def __init__(self, quantized_sequence=None, steps_per_quarter=None,
        ...
        if quantized_sequence:
            ...
            self._events = self._from_quantized_sequence(
                ...
                instrument=instrument, mod_writer=mod_writer)
...
def extract_performances(
        ...
        split_instruments=False, mod_writer=None):
    ...
    mw.write(mw.model_dir, 'quantized_sequence', quantized_sequence)
    for instrument in instruments:
        ...
        quantized_perf_ns = performance.to_sequence()
        quantized_perf_ns.filename = quantized_sequence.filename
        mw.write(mw.model_dir, 'quantized_perf_ns', quantized_perf_ns)
